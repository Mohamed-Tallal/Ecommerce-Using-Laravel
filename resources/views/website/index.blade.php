            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col mt-10 mb-10">
                    ...
                    <div class="header-links">
                        <a href="track-order.html"><img src="{{asset('wesite/assets/images/icons/car.png')}}" alt="Car Icon"> <span>Track your order</span></a>
                        <a href="store.html"><img src="{{asset('wesite/assets/images/icons/marker.png')}}" alt="Car Icon"> <span>Locate Store</span></a>
                ...
                <div class="col mt-15 mb-15">
                    ...
                    <div class="header-logo">
                        <a href="index.html">
                            ...
                            <img class="theme-dark" src="{{asset('wesite/assets/images/logo-light.png')}}" alt="E&E - Electronics eCommerce Bootstrap4 HTML Template">
                        </a>
                    </div><!-- Logo End -->
                </div>
...
<div class="mini-cart-wrap">
    ...
    <ul class="mini-cart-products">
        <li>
            <a class="image"><img src="{{asset('wesite/assets/images/product/product-1.png')}}" alt="Product"></a>
            <div class="content">
        ...
        <li>
            <a class="image"><img src="{{asset('wesite/assets/images/product/product-2.png')}}" alt="Product"></a>
            <div class="content">
        ...
        <li>
            <a class="image"><img src="{{asset('wesite/assets/images/product/product-3.png')}}" alt="Product"></a>
            <div class="content">
    ...
    <div class="container">
        <div class="row row-10">
            ...
            <div class="col-md-8 col-12 mb-30">
                <div class="banner"><a href="#"><img src="{{asset('wesite/assets/images/banner/banner-1.jpg')}}" alt="Banner"></a></div>
            </div>

            <!-- Banner -->
            <div class="col-md-4 col-12 mb-30">
                <div class="banner"><a href="#"><img src="{{asset('wesite/assets/images/banner/banner-2.jpg')}}" alt="Banner"></a></div>
            </div>
                ...
                <div class="offer-product-wrap row">
                    ...
                    <div class="col mb-30">
                        <div class="offer-time-wrap" style="background-image: url({{asset('wesite/assets/images/bg/offer-products.jpg')}})">
                            ...
                            <div class="countdown" data-countdown="2021/03/30"></div>
                        </div>
